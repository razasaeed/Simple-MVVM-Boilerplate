...
public class ActivityDashboardBindingImpl extends ActivityDashboardBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_audios_size, 16);
        sViewsWithIds.put(R.id.cv_videos, 17);
        sViewsWithIds.put(R.id.tv_videos_size, 18);
        sViewsWithIds.put(R.id.cv_contacts, 19);
        sViewsWithIds.put(R.id.tv_contacts_size, 20);
        sViewsWithIds.put(R.id.cv_images, 21);
        sViewsWithIds.put(R.id.tv_images_size, 22);
        sViewsWithIds.put(R.id.cv_documents, 23);
        sViewsWithIds.put(R.id.tv_docs_size, 24);
        sViewsWithIds.put(R.id.cv_apps, 25);
        sViewsWithIds.put(R.id.tv_apps_size, 26);
    }
    // views
    @NonNull
