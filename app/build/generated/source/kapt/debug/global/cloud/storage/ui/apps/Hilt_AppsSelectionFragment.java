...
public abstract class Hilt_AppsSelectionFragment<BINDING extends ViewDataBinding, VM extends BaseViewModel> extends BaseFragment<BINDING, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppsSelectionFragment_GeneratedInjector) this.generatedComponent()).injectAppsSelectionFragment(UnsafeCasts.<AppsSelectionFragment>unsafeCast(this));
    }
  }
