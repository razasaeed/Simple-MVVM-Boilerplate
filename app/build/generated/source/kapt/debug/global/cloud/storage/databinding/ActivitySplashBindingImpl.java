...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_illustration, 6);
        sViewsWithIds.put(R.id.btn_proceed, 7);
        sViewsWithIds.put(R.id.tv_privacy, 8);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((global.cloud.storage.ui.splash.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable global.cloud.storage.ui.splash.SplashViewModel ViewModel) {
